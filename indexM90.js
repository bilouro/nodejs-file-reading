    ...
    lines: new Map([
      [
        ...
        [
          ...
          { name: 'datexc', initialPosition: 34, length: 8, type: 'integer', required: true, dateFormat: 'YYYYMMDD' },
      ...
      [
        ...
        [
          ...
          { name: 'datimm1', initialPosition: 45, length: 8, type: 'string', required: false, dateFormat: 'YYYYMMDD' },
          { name: 'datimm2', initialPosition: 53, length: 8, type: 'string', required: false, dateFormat: 'YYYYMMDD' },
          { name: 'datfvi', initialPosition: 61, length: 8, type: 'string', required: false, dateFormat: 'YYYYMMDD' },
