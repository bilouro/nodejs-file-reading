...
fs.readFile('./files/358M5121010700153307.txt', 'utf8', (err, data) => {
   const dataObjects = getObjectsFromFile(data, getFileMapping()); //salvar esta lista no banco.
    ...
    const uniqueList = uniquifyList(list5100, ['children5101', 'children5120', 'children5199'], getUniqueValue);  //processar essa lista no converter.
    console.log('======================================================');
    ...
    lines: new Map([
      ...
      [
        ...
        [
          ...
          { name: 'codacl', initialPosition: 67, length: 3, type: 'string', required: false },
          ...
          { name: 'codrgt', initialPosition: 114, length: 3, type: 'string', required: false },
      ...
      [
        ...
        [
          ...
          // { name: 'id5120', type: 'parent', parentDiscriminator:'51.20', parentAttribute:'uuid'},
        ],
      ],
      [
        '51.31',
      ...
      [
        ...
        [
          ...
          { name: 'heuexc', initialPosition: 42, length: 6, type: 'string', required: false },
          { name: 'numexc', initialPosition: 48, length: 7, type: 'integer', required: false },
          { name: 'cptexc', initialPosition: 55, length: 8, type: 'string', required: false },
          ...
          { name: 'dsiexc', initialPosition: 121, length: 135, type: 'string', required: false },
        ],
      ],
    ]),
  };
